package com.example.testrecordscreen.base;
...
public abstract class MyDisplayBase implements GetAacData, GetVideoData, GetMicrophoneData {
    ...
    public MyDisplayBase(Context context, boolean useOpengl) {
